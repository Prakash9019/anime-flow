...
export default function BulkUpload(): React.ReactElement {
  ...
  const handleUpload = () => {
    if (!fileName) return Alert.alert('Please select a file');
    Alert.alert('Uploaded', fileName);
  };

  return (
    <SafeAreaView style={styles.container}>
      <AdminHeader title="Bulk Upload" showBack />
      <View style={styles.content}>
        <Text style={styles.instructions}>
          1. Download the skeleton file and fill with proper data.{'\n'}
          2. Once edited, upload in the form and submit.{'\n'}
          3. For multiple options, separate by comma.
        </Text>
